...
CreateConVar( "cfc_parachute_min_lurch", 30, { FCVAR_REPLICATED, FCVAR_ARCHIVE }, "Minimum downwards force a parachute can receive from weapon-induced lurches.", 0, 50000 )
CreateConVar( "cfc_parachute_max_lurch", 100, { FCVAR_REPLICATED, FCVAR_ARCHIVE }, "Maximum downwards force a parachute can receive from weapon-induced lurches.", 0, 50000 )
...
CreateConVar( "cfc_parachute_shoot_lurch_chance", 0.2, { FCVAR_REPLICATED, FCVAR_ARCHIVE }, "The chance for a parachute to lurch downwards when the player shoots a bullet.", 0, 1 )
