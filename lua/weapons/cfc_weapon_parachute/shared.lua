...
CreateConVar( "cfc_parachute_horizontal_speed", 100, { FCVAR_REPLICATED, FCVAR_ARCHIVE }, "How quickly you move in a furled parachute.", 0, 50000 )
...
CreateConVar( "cfc_parachute_destabilize_max_lurch", 150, { FCVAR_REPLICATED, FCVAR_ARCHIVE }, "Maximum downwards force a parachute can receive from random lurches while destabilized.", 0, 180 )
