...
function SWEP:Initialize()
    ...
    self.Primary.DamageDice = {
        ...
        { Damage = 1000, Weight = 20, KillIcon = "superlucky", Sound = "physics/glass/glass_largesheet_break1.wav", },
        { Damage = 0, Weight = 4, KillIcon = "unlucky", Sound = "npc/manhack/gib.wav", SoundPitch = 130, SelfDamage = 1000, SelfForce = 5000, },
