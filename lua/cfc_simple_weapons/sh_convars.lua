...
ClassicMode = CreateConVar( "cfc_simple_weapons_classic_mode", 0, { FCVAR_ARCHIVE, FCVAR_REPLICATED }, "Disables the raise/lower system.", 0, 1 )
...
LoweredReloads = CreateConVar( "cfc_simple_weapons_lowered_reloads", 1, { FCVAR_ARCHIVE, FCVAR_REPLICATED }, "Whether weapons can be reloaded when lowered.", 0, 1 )
...
if CLIENT then
    NoAutoRaise = CreateClientConVar( "cfc_simple_weapons_disable_raise", 0, true, true, "Disables left click raising your weapon.", 0, 1 )
    ...
    AimZoom = CreateClientConVar( "cfc_simple_weapons_zoom", 1.25, true, true, "The amount of zoom to apply when raising a weapon.", 1, 1.5 )
